...
class ServiceQueues
{
    ...
    const TOTAL_CHARACTER_FRIENDS    = 1;  // Max 4 pages
    const TOTAL_ACHIEVEMENT_UPDATES  = 1;  // Always 10 pages
    const TOTAL_FREE_COMPANY_UPDATES = 1;  // Max: 10 pages
    const TOTAL_PVP_TEAM_UPDATES     = 1;  // Usually only 1 page
    const TOTAL_LINKSHELL_UPDATES    = 1;  // Max 3 pages
}
